...
public class Producto {
  ...
  public void registrar(){
    ...
    registro = codigoProducto + "_" + nombreProducto + "_" + cantidadExistente + "_" + precioUnitario; //Contatenacion y transformacion en un solo registro
  ...
  public void mostrar(){
      ...
      try (BufferedReader br = new BufferedReader(new FileReader("c:/ficheros/datos.txt"))) {
            while ((linea = br.readLine()) != null) {
                ...
                if (componente.length >= 4){ //Verificacion de componentes (Código, Nombre, Cantidad y Precio)
                    // Mostrar datos
